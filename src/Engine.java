...
public class Engine {
    ...
    public void kun() throws IOException {
        ...
        testImage=ImageIO.read(new File("F:\\IITian's\\IDEA_WS\\Skin Detection\\ibtd\\1002.jpg"));
        ...
        outputFile = new File("F:\\IITian's\\IDEA_WS\\Skin Detection\\Processed\\+0001.jpg");
